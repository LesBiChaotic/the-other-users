...
export const ROUTE_REGISTRY: Record<string, RouteMetadata> = {
  ...
  '/menagerie/enclosure/:id': {
    path: '/menagerie/enclosure/:id',
    surfaceName: 'Enclosure Control Station',
    chapterRequirement: 5,
    gateId: 'G5',
    unlockCondition: { type: 'gateReached', gateId: 'G5' },
    fallbackPath: '/menagerie/ops',
    deniedMessage: 'Enclosure control station restricted.',
  },
  '/menagerie/threshold': {
    path: '/menagerie/threshold',
    surfaceName: 'Ilyr Threshold Exit Procedure',
    chapterRequirement: 5,
    gateId: 'G5',
    unlockCondition: { type: 'gateReached', gateId: 'G5' },
    fallbackPath: '/menagerie/ops',
    deniedMessage: 'Threshold exit protocol restricted.',
  },
  '/convergence': {
    path: '/convergence',
