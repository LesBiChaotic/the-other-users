...
export const ROUTE_REGISTRY: Record<string, RouteMetadata> = {
  ...
  '/wire/thread/:id': {
    path: '/wire/thread/:id',
    surfaceName: 'Witness Wire Thread Detail',
    chapterRequirement: 0,
    gateId: 'G0',
    unlockCondition: { type: 'gateReached', gateId: 'G0' },
    fallbackPath: '/wire',
    deniedMessage: 'Thread unavailable.',
  },
  '/wire/user/:handle': {
    path: '/wire/user/:handle',
    surfaceName: 'Witness User Observation Profile',
    chapterRequirement: 0,
    gateId: 'G0',
    unlockCondition: { type: 'gateReached', gateId: 'G0' },
    fallbackPath: '/wire',
    deniedMessage: 'User profile unavailable.',
  },
  '/molt': {
    path: '/molt',
